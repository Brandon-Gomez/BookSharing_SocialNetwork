                ...
                <ul class="navbar-nav navbar-mega-nav pe-lg-2 me-lg-2">
                  <li class="nav-item dropdown">
                    <a
                      ...
                      href="#"
                      data-bs-toggle="dropdown"
                      ><i class="ci-view-grid me-2"></i>Categorias</a
                    >
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                      <li class="dropdown position-static mb-0">
                        ...
                        >
                        <div
                          class="dropdown-menu h-100 animation-none mt-0 p-3"
                        >
                          <a
                            class="d-block"
                            href="home-nft.html"
                      ...
                      <li class="dropdown position-static mb-0">
                        <a
                          ...
                          ><span class="d-block text-heading"
                            >Single Book Store</span
                          ><small class="d-block text-muted"
                            >Single book / mono brand</small
                          ></a
                        >
                        <div
                          class="dropdown-menu h-100 animation-none mt-0 p-3"
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu p-0">
                      <div class="d-flex flex-wrap flex-sm-nowrap px-2">
                        ...
                        <div
                          class="mega-dropdown-column pt-1 pt-lg-4 px-2 px-lg-3"
                        >
                          <div class="widget widget-links mb-4">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                          ...
                          <li>
                            <a class="dropdown-item" href="dashboard-books.html"
                              >Books</a
                            >
                          </li>
                          <li>
                            <a
                              class="dropdown-item"
                              href="dashboard-add-new-book.html"
                              >Add New Book</a
                            >
                          </li>
                          <li>
          ...
          <div class="col-xl-8 col-lg-10">
            <div class="row">
              <div class="col-sm-4 mb-3">
                <a class="card h-100 border-0 shadow-sm" href="index.html">
                  <div class="card-body">
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <div class="ps-3">
                        ...
                        <span class="text-muted fs-ms"
                          >Find with advanced search</span
                        >
                      </div>
                    </div>
                  </div>
