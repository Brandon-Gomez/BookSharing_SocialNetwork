              ...
              >
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <a class="btn-tag me-2 mb-2" :href="`/category/${post.category_id}`"
  ...
  methods: {
    ...
    async fetchPost() {
      try {
        ...
        // Aquí obtienes el username del usuario dueño del post
        const username = response.data.user.username;
        // Llama a fetchUser con el username correcto
